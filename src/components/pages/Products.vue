<template>
    <div>
        ...
        <nav aria-label="Page navigation example">
            <ul class="pagination">
                <li class="page-item">
                    <a :class="{'disabled':!pagination.has_pre}" 
                ...
                <li class="page-item">
                    <a :class="{'disabled':!pagination.has_next}"
...
export default {
    ...
    methods: {
        ...
        updateProduct(){
            ...
            if(!vm.isNew){
                api=`https://vue-course-api.hexschool.io/api/yop/admin/product/:id`;
                httpMethod='put';
            }
        ...
        uploadFile(){
            ...
            const url=`https://vue-course-api.hexschool.io/api/thisismycourse2/admin/upload`
